...
public class SensorValueCollection {
    ...
    private static SensorValueInfo humidity = new SensorValueInfo("humidity",25,Color.RED,60,Color.RED,"Humidity too low!","Humidity too high!","Perfect humidity", new PercentageConverter());
    ...
    private static SensorValueInfo luminosity = new SensorValueInfo("luminosity",200,Color.RED,500,Color.RED,"Too dark!","Too bright!","Dark enough",new PercentageConverter());
    ...
    private static SensorValueInfo proximity = new SensorValueInfo("proximity",100,Color.BLACK,1000,Color.RED,"Nobody is touching","Somebody is touching!","Somebody is near!",new PercentageConverter());
    private static SensorValueInfo noiseLevel = new SensorValueInfo("noiseLevel",135,Color.BLACK,145,Color.RED,"No Sound","Loud noise!","A little noisy",new PercentageConverter());
